...
public abstract class MixinYggdrasilMinecraftSessionService {
   ...
   @Redirect(
      ...
      at = @At(
   value = "FIELD",
   target = "com/mojang/authlib/yggdrasil/YggdrasilMinecraftSessionService.JOIN_URL:Ljava/net/URL;"
)
   )
   private URL f$E() throws MalformedURLException {
      return JG.f$E().equals(ki.f$M) ? new URL("http://sessionserver.thealtening.com" + JOIN_URL.getFile()) : JOIN_URL;
   }
}
